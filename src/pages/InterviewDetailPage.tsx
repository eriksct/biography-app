...
import { ArrowLeft, Play, Pause, Plus, MapPin, User, Pencil, Check, Download, FileText, Music, Calendar, ScrollText, Target, BookOpen, X } from 'lucide-react';
              ...
              >
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <button
                    ...
                    className="opacity-0 group-hover/passage:opacity-100 transition-opacity p-1 rounded hover:bg-muted text-muted-foreground hover:text-foreground"

...
import { Mic, FileText, CheckCircle, Plus, Search, X, Loader2, Pencil, MessageCircle } from 'lucide-react';
...
export default function InterviewsPage() {
  ...
  return (
    <AppLayout>
      ...
      {/* Mobile FAB */}
      {isMobile && sortedInterviews.length > 0 && (
        <button
